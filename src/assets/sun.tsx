...
const SvgStyle = styledComponentsTS<svgprops>(styled.div)`
  height: auto;
  width: 100%;
  path {
    opacity: ${props => {
      return props.opacity >= 20 ? props.opacity / 100 : 0.2
    }}
  }
`

export const SunSVG: React.SFC<svgprops> = props => (
  <SvgStyle opacity={props.opacity}>
    <svg
      version="1.1"
      id="Capa_1"
      x="0px"
